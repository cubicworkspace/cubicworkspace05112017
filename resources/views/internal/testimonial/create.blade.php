                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
									...
									@endif
						            <form action="/testimonial/@yield('editForm')" method="POST" enctype="multipart/form-data">
									{{csrf_field()}}
									...
									<tr>
									    ...
									    <input class="btn btn-default" type="reset" name="batal" value="Cancel" onclick="location.href='/testimonial/'"/></td>
									</tr>
									</table>
									</div>
									</form>
