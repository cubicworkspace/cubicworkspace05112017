...
@section('title','Create Category Payment Methode')
@section('content')  
 <!-- BEGIN CONTENT BODY -->
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="{{ url('/categorypaymentmethode') }}">Category Payment Methode</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                <li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
									...
									@endif
						            <form action="/categorypaymentmethode/@yield('editForm')" method="POST" enctype="multipart/form-data">
									{{csrf_field()}}
									...
									<tr>
									    ...
									    <input class="btn btn-default" type="reset" name="batal" value="Cancel" onclick="location.href='/categorypaymentmethode/'"/></td>
									</tr>
									</table>
									</div>
									</form>
