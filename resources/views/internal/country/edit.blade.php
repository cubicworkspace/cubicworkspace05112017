                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
									...
									@endif
						            <form action="/country/{{ $edit->id }}" method="POST" enctype="multipart/form-data">
									{{ csrf_field() }}
									{{ method_field('PUT') }}
									...
									<tr>
										<td>Flag</td>
										<td>:</td>
										<td><img src="{{ asset('upload/country') }}/{{ $edit->flag }}" width="80"></td>
									</tr>
									<tr>
										<td>Edit Flag</td>
										<td>:</td>
										<td><input type="file" name="flag"  value="" class="form-control" ></td>
									</tr>
								@else
									<tr>
										<td>Flag</td>
										<td>:</td>
										<td><input type="file" name="flag"  value="{{ $edit->flag }}" class="form-control" ></td>
									</tr>
								@endif
									<tr>
										<td>Status</td>
									...
									<tr>
									    ...
									    <input class="btn btn-default" type="reset" name="batal" value="Cancel" onclick="location.href='/country/'"/></td>
									</tr>
									</table>
									</div>
									</form>
