                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="{{ url('/categoryservices') }}">Category Services</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                <li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
									...
									@endif
						            <form action="/categoryservices/{{ $edit->id }}" method="POST" enctype="multipart/form-data">
									{{ csrf_field() }}
									{{ method_field('PUT') }}
						            ...
						            <tr>
										...
										<td>:</td>
										<td><b>{{ $edit->codecategoryservices }} </b></td>
									</tr>
						            <tr>
										<td>Name</td>
										<td>:</td>
