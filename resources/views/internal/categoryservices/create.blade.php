                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="{{ url('/services') }}">Category Services </a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                <li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
									...
									@endif
						            <form action="/categoryservices/@yield('editForm')" method="POST" enctype="multipart/form-data">
									{{csrf_field()}}
									...
									<tr>
										...
										<td>:</td>
										<td><input type="text" name="codecategoryservices" value="{{ $no }}" class="form-control" ></td>
									</tr>
						            <tr>
										<td>Name</td>
										<td>:</td>
