                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="{{ url('/categoryevent') }}">Category Event</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                <li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
									...
									@endif
						            <form action="/categoryevent/@yield('editForm')" method="POST" enctype="multipart/form-data">
									{{csrf_field()}}
									<div class="table-responsive">
						              ...
						              <tr>
										...
										<td>:</td>
										<td><input type="text" value="{{ $no }}" name="codecategoryevent"  class="form-control" ></td>
									</tr>
						              <tr>
										<td>Name</td>
										<td>:</td>
									...
									<tr>
									    ...
									    <input class="btn btn-default" type="reset" name="batal" value="Cancel" onclick="location.href='/categoryevent/'"/></td>
									</tr>
									</table>
									</div>
									</form>
