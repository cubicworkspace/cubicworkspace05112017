...
@section('title','Edit Billing Company Services')
@section('content')  
 <!-- BEGIN CONTENT BODY -->
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="{{ url('/billingcompanyservices') }}">Billing Company Services</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                <li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
									...
									@endif
						            <form action="/billingcompanyservices/{{ $edit->id }}" method="POST" enctype="multipart/form-data">
									{{ csrf_field() }}
									{{ method_field('PUT') }}
						          ...
						          <tr>
									...
									<tr>
									    ...
									    <input class="btn btn-default" type="reset" name="batal" value="Cancel" onclick="location.href='/billingcompanyservices/'"/></td>
									</tr>
									</table>
									</div>
									</form>
