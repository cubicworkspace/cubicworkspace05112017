                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
									...
									@endif
						            <form action="/message/{{ $edit->id }}" method="POST" enctype="multipart/form-data">
									{{ csrf_field() }}
									{{ method_field('PUT') }}
						           ...
						           <tr>
									...
									<tr>
									    ...
									    <input class="btn btn-default" type="reset" name="batal" value="Cancel" onclick="location.href='/message/'"/></td>
									</tr>
									</table>
									</div>
									</form>
