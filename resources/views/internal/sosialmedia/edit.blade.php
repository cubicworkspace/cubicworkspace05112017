                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="{{ url('/sosialmedia') }}">Social Media</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                <li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
						            ...
						            <form action="/sosialmedia/{{ $edit->id }}" method="POST" enctype="multipart/form-data">
									{{ csrf_field() }}
									{{ method_field('PUT') }}
									...
									<tr>
									    ...
									    <input class="btn btn-default" type="reset" name="batal" value="Cancel" onclick="location.href='/sosialmedia/'"/></td>
									</tr>
									</table>
									</div>
									</form>
